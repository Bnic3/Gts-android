...
public class FragmentOne extends Fragment {
    ...
    private Button fragonebutton;

    public ImageButton estatebtn;
    public AppCompatImageButton userbtn;

    public TextView estateTV;
    public TextView userTV;

    public AppCompatImageButton anoda;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        estatebtn = (ImageButton) v.findViewById(R.id.estateBtn2);
        userbtn = (AppCompatImageButton) v.findViewById(R.id.userBtn);

        estateTV = (TextView) v.findViewById(R.id.estateTV);
        userTV = (TextView) v.findViewById(R.id.userTV);

       /* estateTV.setTypeface(EasyFonts.robotoThin(getActivity()));
        userTV.setTypeface(EasyFonts.robotoBold(getActivity()));*/
